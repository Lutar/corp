...
<div class="widget-last widget text-image">
    <h3>{{ trans('ru.support') }}</h3>
    <div class="text-image" style="text-align:left"><img src="{{ asset(env('THEME')) }}/images/callus.gif" alt="{{ trans('ru.support') }}" /></div>
