    ...
    @if($article)
        <div class="hentry hentry-post blog-big group ">
            ...
            <div class="meta group">
                ...
                <p class="categories"><span>In: <a href="{{ route('articlesCat', ['cat_alias'=>$article->category->alias]) }}" title="View all posts in {!! $article->category->title !!}" rel="{!! $article->category->title !!}">{!! $article->category->title !!}</a></span></p>
